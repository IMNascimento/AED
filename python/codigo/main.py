...
if __name__ == '__main__':
    json_file_path = 'C:\\xampp\\htdocs\\python\\AED\\codigo\\data_itsa4.json'  
    data = load_data_from_json(json_file_path)

    # Build trees and measure performance
    ...
    # Perform searches and check if the inserted data can be found
   ...
   # Perform removals and check if the data can be removed
    ...
    # geração grafica da arvore
    b_tree = build_binary_tree(data)
    m_tree = build_m_tree(data)
    ts_tree = build_ts_tree(data)

    # Visualizar árvores
    graph_b = visualize_binary_tree(b_tree)
    graph_m = visualize_m_tree(m_tree)
    graph_ts = visualize_ts_tree(ts_tree)

    # Salvar os gráficos em arquivos de imagem ou PDF
    graph_b.render('C:\\xampp\\htdocs\\python\\AED\\codigo\\output\\binary_tree', view=True)
    graph_m.render('C:\\xampp\\htdocs\\python\\AED\\codigo\\output\\m_tree', view=True)
    graph_ts.render('C:\\xampp\\htdocs\\python\\AED\\codigo\\output\\ts_tree', view=True)